...
import CanceledOrder from 'app/routes/_store.orders_.$orderId.result/CanceledOrder'
import SuccessOrder from 'app/routes/_store.orders_.$orderId.result/SuccessOrder'
